...
expName = 'adpative_staircase'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\PRIYANSHI\\Pictures\\Screenshots\\lab psy priyanshi\\Adpative.staircase_priyanshi\\adpative_staircase_lastrun.py',
